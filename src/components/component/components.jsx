...
* @see https://v0.dev/t/v3I3gsUHVDB
...
export function components() {
  return (
    (<main
      className="flex flex-col h-screen w-full bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-50">
      <header
              ...
              <div>
                ...
                <div className="flex items-center justify-center h-full">
                  <Input
                    className="mr-4"
                    id="scan-start"
                    placeholder="Enter start cylinder"
                    type="number" />
                  <Input
                    className="ml-4"
                    id="scan-end"
                    placeholder="Enter end cylinder"
                    type="number" />
                </div>
                <LineChart className="w-full h-full" />
              </div>
